        ...
        <div class="row g-4">
            @foreach ($places as $place)
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div wire:click="startOrder({{ $place->id }})"
                        ...
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <span class="status-indicator" style="background-color: {{ $place->getStatusColor() }}"></span>
                            </div>

                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="text-muted me-2">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow">
                    ...
                    <div class="modal-body">
                        <p>{{ $selectedPlace->name }} ({{ $selectedPlace->capacity }} kishilik) yangi buyurtma boshlashingiz mumkin.</p>
                        <!-- Add your order form here -->
                    </div>
                    <div class="modal-footer border-0">
                        <button type="button" class="btn btn-outline-secondary" wire:click="cancelOrder">Bekor qilish</button>
